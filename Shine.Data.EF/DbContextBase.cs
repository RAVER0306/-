...
using TransactionalBehavior = Shine.Core.Data.TransactionalBehavior;
...
namespace Shine.Data.EF
{
        ...
        where TDbContext : DbContext, IUnitOfWork, new()
    {
        ...
        {
            return _contextConfig ?? (_contextConfig = ShineConfig.Instance.DataConfig.ContextConfigs
        ...
        internal virtual int SaveChanges(bool validateOnSaveEnabled)
        {
            ...
            catch (DbUpdateException e)
            {
                if (e.InnerException != null && e.InnerException.InnerException is SqlException)
                {
                    ...
                    throw new ComException("提交数据更新时发生异常：" + msg, sqlEx);
                }
                throw;
            }
            finally
