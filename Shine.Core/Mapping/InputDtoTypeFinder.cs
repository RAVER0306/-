    ...
    public class InputDtoTypeFinder : IMapSourceTypeFinder
    {
        ...
        public virtual Type[] FindAll()
        {
            ...
            return assemblies.SelectMany(assembly =>
                assembly.GetTypes().Where(type => (typeof(IInputDto).IsAssignableFrom(type) || typeof(IInputDto<>).IsGenericAssignableFrom(type)) && !type.IsAbstract))
                .Distinct().ToArray();
        }
    }
}