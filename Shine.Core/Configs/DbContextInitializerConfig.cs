...
namespace Shine.Core.Configs
{
    ...
    public class DbContextInitializerConfig
    {
        ...
        internal DbContextInitializerConfig(DbContextInitializerElement element)
        {
            ...
            InitializerType = type ?? throw new InvalidOperationException(Resources.DbContextInitializerConfig_InitializerNotExists.FormatWith(element.InitializerTypeName));
