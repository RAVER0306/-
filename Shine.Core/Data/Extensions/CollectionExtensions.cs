...
using Shine.Comman.Reflection;
using Shine.Core.Mapping;
using Shine.Core.Properties;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Linq.Expressions;

namespace Shine.Core.Data.Extensions
{
    /// <summary>
    /// 集合扩展辅助操作类
    /// </summary>
    public static class CollectionExtensions
    {
            ...
            Expression<Func<TEntity, TResult>> selector)
        {
            ...
            return new PageResult<TResult>() { Total = total, ListData = data };
        }
            ...
            where TOutputDto : IOutputDto
        {
            ...
            return new PageResult<TOutputDto>() { Total = total, ListData = data };
        }
        ...
        {
            DateTime now = DateTime.Now;
            Func<TEntity, bool> predicate = m => m.EndTime != null && m.EndTime.Value < now;
            return source.Where(predicate);
        }
