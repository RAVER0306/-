...
namespace Shine.Core.Data
{
    ...
    public abstract class EntityBase<TKey> : IEntity<TKey> where TKey : IEquatable<TKey>
    {
        ...
        protected EntityBase()
        {
            ...
            {
                _id = CombHelper.NewComb().CastTo<TKey>();
            }
        }
        ...
        public TKey Id
        {
            ...
            get
            {
                if (typeof(TKey) == typeof(Guid) && _id.ToString()==("00000000-0000-0000-0000-000000000000"))
                {
                    return _id = CombHelper.NewComb().CastTo<TKey>();
                }
                else
                {
                    return _id;
