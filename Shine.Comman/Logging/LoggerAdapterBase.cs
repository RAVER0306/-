...
namespace Shine.Comman.Logging
{
    /// <summary>
    ...
    public abstract class LoggerAdapterBase : ILoggerAdapter
    {
        ...
        protected  virtual ILog GetLoggerInternal(string name)
        {
            ...
            _cacheLoggers[name] = log ?? throw new NotSupportedException(Resources.Logging_CreateLogInstanceReturnNull.FormatWith(name, GetType().FullName));
            return log;
        }
    }
}