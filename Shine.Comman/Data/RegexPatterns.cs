namespace Shine.Comman.Data
{
    ...
    public class RegexPatterns
    {
        ...
        /// 匹配邮箱
        /// </summary>
        public const string RegexEmail = @"\w[-\w.+]*@([A-Za-z0-9][-A-Za-z0-9]+\.)+[A-Za-z]{2,14}";
        ...
        /// 匹配手机号码
        /// </summary>
        public const string RegexPhone = @"(13\d|14[579]|15[^4\D]|17[^49\D]|18\d)\d{8}";

        /// <summary>
        /// 匹配负整数
        /// </summary>
        public const string RegexNInt = @"-[1-9]\d*";

        /// <summary>
        /// 匹配正整数
        /// </summary>
        public const string RegexPInt = @"[1-9]\d*";
        ...
        /// 匹配IP地址
        /// </summary>
        public const string RegexIP = @"(\d+)\.(\d+)\.(\d+)\.(\d+)";

        /// <summary>
        /// 至少n位的数字：^\d{<paramref name="n"/>,}$
        /// </summary>
        /// <param name="n"></param>
        /// <returns></returns>
        public static string RegexAtLeast(int n)
        {
            return @"^\d{" + n + @",}$";
        }
    }
